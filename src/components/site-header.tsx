...
export function SiteHeader({ onAbout = false, onServices = false, onProjects = false, onPlant = false, onCompliance = false, onContact = false }: { onAbout?: boolean; onServices?: boolean; onProjects?: boolean; onPlant?: boolean; onCompliance?: boolean; onContact?: boolean }) {
  ...
  return <header className="site-header">
    <div className="header-inner wrap">
      ...
      <Link href={onContact ? "#enquiry" : "/contact"} className="header-cta" aria-current={onContact ? "page" : undefined}><span className="header-cta-label">Contact us</span><span className="header-cta-short">Contact us</span><span className="header-cta-arrow" aria-hidden="true"><ArrowIcon /></span></Link>
      <ThemeToggle />
