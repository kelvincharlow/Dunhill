...
export default function Compliance() {
  return <><a className="skip-link" href="#main">Skip to content</a><SiteHeader onCompliance /><main id="main" tabIndex={-1}>
    ...
    <section className={`wrap ${styles.contact}`} id="contact"><div><p className="eyebrow">NEED SOMETHING ELSE?</p><h2>Let’s talk through<br /><em>your requirements.</em></h2></div><Link className="button" href="/contact?service=Compliance%20documents#enquiry">Contact our team <span aria-hidden="true">↗</span></Link></section>
  </main><InnerFooter /></>;
}
