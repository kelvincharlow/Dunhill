...
export const metadata: Metadata = { title: "Plant & Machinery | Dunhill Building Contractors", description: "Explore Dunhill’s construction equipment, transport, site resources, timber joinery and metal fabrication workshops." };
const equipment = [
...
export default function PlantWorkshops() {
  return <><a className="skip-link" href="#main">Skip to content</a><SiteHeader onPlant /><main id="main" tabIndex={-1}>
    <section className={`wrap ${styles.hero}`} aria-labelledby="plant-title"><p className="eyebrow">DUNHILL / PLANT & MACHINERY</p><div className={styles.heading}><h1 id="plant-title">The tools.<br /><em>The craft.</em></h1><div><p>Construction plant on site. Timber and metal expertise in the workshop. Connected resources, from preparation to finishing.</p><p className={styles.location}><span aria-hidden="true"><ArrowIcon /></span> Workshops in Embakasi, off Mombasa Road.</p></div></div><nav className={styles.jump} aria-label="Explore plant and machinery"><a href="#equipment"><small>01</small>Plant & equipment <span aria-hidden="true"><ArrowIcon direction="down" /></span></a><a href="#joinery-workshop"><small>02</small>Timber joinery <span aria-hidden="true"><ArrowIcon direction="down" /></span></a><a href="#metal-workshop"><small>03</small>Metal fabrication <span aria-hidden="true"><ArrowIcon direction="down" /></span></a></nav></section>

    <section className={`wrap ${styles.equipment}`} id="equipment" aria-labelledby="equipment-title">
      <div className={styles.siteVisual}><figure><Image src="/images/profile/industrial-03.jpeg" alt="Construction plant beside a steel-framed building at a Dunhill site" fill sizes="(max-width: 800px) calc(100vw - 44px), 44vw" /><figcaption>ON SITE / PLANT IN CONTEXT</figcaption></figure><Link className="text-link" href="/projects">See the work it supports <span aria-hidden="true"><ArrowIcon /></span></Link></div>
      <div><p className="eyebrow">PLANT & EQUIPMENT</p><h2 id="equipment-title">Ready for<br /><em>the practical details.</em></h2><dl className={styles.inventory}>{equipment.map(([title, items], index) => <div key={title}><dt><small>0{index + 1}</small>{title}</dt><dd>{items}</dd></div>)}</dl><p className={styles.note}>Equipment types follow the 2026 company profile. Confirm specifications, quantities and availability for your project with our team.</p><Link className="text-link" href={enquiry("Plant & machinery")}>Discuss equipment requirements <span aria-hidden="true"><ArrowIcon /></span></Link></div>
    </section>
    ...
    <section className={`wrap ${styles.contact}`} id="contact" aria-labelledby="contact-title"><div><h2 id="contact-title">Bring us your plans.</h2><p>Let’s connect the right resources to your project.</p></div><Link className="button" href={enquiry("Plant & machinery")}>Discuss your requirements <span aria-hidden="true"><ArrowIcon /></span></Link></section>
  </main><InnerFooter /></>;
}
